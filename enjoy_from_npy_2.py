...
label1 = "AHGQN + PPD-based Reward"
label2 = "AHGQN + Fixed Comfort Temperature Range"
...
ax3.legend(loc='upper left',ncol=2,bbox_to_anchor=(-0.01,1.1))
...
# plt.show()
plt.savefig("HGQN_vs_DQN.pdf", dpi=300)
